      ...
      <footer className="bg-tron-dark py-8 text-white/90 border-t border-violet-500/20">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <p className="text-sm text-violet-300/80">
            Powered by <a href="https://kleros.io" className="text-violet-300 hover:text-violet-200 transition-colors">Kleros Protocol</a> · <span className="text-violet-300/60">Kleros Escrow v1 · Ethereum Mainnet</span>
          </p>
        </div>
      </footer>
    </div>
